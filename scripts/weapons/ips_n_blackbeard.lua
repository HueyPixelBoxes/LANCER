...
function Prime_SwordGrapple:GetSkillEffect(p1, p2)
	...
	local dist_damage = (p1:Manhattan(target) / 2 - 1) <= 3 and (p1:Manhattan(target) - 1) / 2 or
	3                                                                                        -- add damage per distance
	...
	sword_damage.sAnimation = not self.Cleave and "explospear1_" .. direction or
	"explosword_" .. direction                                                                       -- sword animation if cleave
